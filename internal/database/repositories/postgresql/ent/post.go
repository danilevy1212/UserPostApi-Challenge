...
func (e PostEdges) UserIDOrErr() (*User, error) {
	if e.UserID != nil {
		return e.UserID, nil
...
// QueryUserID queries the "user_id" edge of the Post entity.
func (po *Post) QueryUserID() *UserQuery {
	return NewPostClient(po.config).QueryUserID(po)
}
